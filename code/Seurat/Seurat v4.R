...
# Find anchors
transfer_anchors <- FindTransferAnchors(reference=train_seurat, query=test_seurat, reduction="cca", dims=1:50)   # reduction = "cca" for Seurat v4 (CCA) and reduction = "pcaproject" for Seurat v4 (PCA)
...
write.table(test_protein_prediction, file.path(save_dir, "test_protein_prediction (Seurat v4 (CCA)).txt"))   # CCA or PCA
